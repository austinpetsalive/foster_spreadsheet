...
while count <= end and blank <13:
	...
	if (len(animalid)>1) and (row is not None):
			...
			if ((personinternalid >0) and ("Foster" in animal['AnimalStatus'] or "Pre-Adopt" in animal['AnimalStatus'] or  animal['AnimalStatus'] == 'Healthy In Home' or "Shelter" in animal['AnimalStatus'] or "Deceased" in animal['AnimalStatus'] )):
				person=""
